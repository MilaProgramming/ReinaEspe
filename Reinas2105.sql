...
CREATE TABLE `calificacion` (
  ...
  PRIMARY KEY (`CALIFICACION_ID`,`CANDIDATA_ID`),
  KEY `FK_ABARCA` (`EVENTO_ID`),
  KEY `FK_ADMINISTRA` (`USUARIO_ID`),
  KEY `FK_RECIBE_idx` (`CANDIDATA_ID`),
  ...
  CONSTRAINT `FK_RECIBE` FOREIGN KEY (`CANDIDATA_ID`) REFERENCES `candidata` (`CANDIDATA_ID`)
...
INSERT INTO `calificacion` VALUES (1,201,1,1,'Trajes',45,3),(2,202,1,1,'Trajes',45,9),(3,203,1,1,'Trajes',45,7),(4,201,1,1,'Trajes',45,3);
...
INSERT INTO `candidata` VALUES (201,501,701,'Watson','Zambrano','Emma','Guatson','2000-10-05','Enseñar Programación',1.77,'Sabe Karate','Inglés, Español','Azul','Cenizo',0),(202,501,701,'Jolie','Gualotuña','Angelina','Yuleiza','1999-04-07','Vender Queso',1.60,'Juega LoL','Español, Francés','Marrón','Marrón',0),(203,501,701,'Johannson','Godoy','Scarlet','Andrea','1998-03-27','Meditar',1.83,'Leer Sci-Fi','Español, Francés','Marrón','Rojo',0);
...
INSERT INTO `evento` VALUES (1,701,'Traje',45,0.00);
...
INSERT INTO `foto_candidata` VALUES (301,201,'Emma Guatson 1','C:\\fakepath\\ew1.jpg'),(302,201,'Emma Guatson 2','C:\\fakepath\\sj2.jpg'),(303,201,'Emma Guatson 3','C:\\fakepath\\ew3.jpg'),(311,202,'Angelina Jolie 1','C:\\fakepath\\aj1.jpg'),(312,202,'Angelina Jolie 2','C:\\fakepath\\aj2.jpg'),(313,202,'Angelina Jolie 3','C:\\fakepath\\aj3.jpg'),(321,203,'Scarlet Johannson 1','C:\\fakepath\\sj1.jpg'),(322,203,'Scarlet Johannson 2','C:\\fakepath\\sj2.jpg'),(323,203,'Scarlet Johannson 3','C:\\fakepath\\sj3.jpg');
...
INSERT INTO `usuario` VALUES (1,701,'juan','juan','juan','juan','juan','1789456789');
...
-- Dump completed on 2023-05-21  1:24:33
